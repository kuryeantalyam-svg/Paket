    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="max-w-6xl w-full flex flex-col gap-12">
              ...
              <div className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    a: "Ödemeyi gönderici ödemeli veya alıcı ödemeli olarak nakit veya kuryelerimizdeki POS cihazları üzerinden kredi kartı ile yapabilirsiniz."
                  }
                ].map((faq, i) => (
              ...
              <div>
                ...
                <ul className="space-y-4 text-sm text-slate-500">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span>destek@smartpack.com</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <MapPin className="w-4 h-4 text-indigo-600" />
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 z-[4000] w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
